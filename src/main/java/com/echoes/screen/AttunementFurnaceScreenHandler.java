...
public class AttunementFurnaceScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate props;

    /** Client constructor. */
    public AttunementFurnaceScreenHandler(int syncId, PlayerInventory playerInv) {
        this(syncId, playerInv, new SimpleInventory(2), new ArrayPropertyDelegate(3));
    }

    public AttunementFurnaceScreenHandler(int syncId, PlayerInventory playerInv, Inventory inv, PropertyDelegate props) {
