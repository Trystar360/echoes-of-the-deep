...
/** A Resonant sword — tuned hard, per Walter Russell's balanced interchange. */
public class ResonantSwordItem extends SwordItem {
    public ResonantSwordItem(ToolMaterial material, float attackDamage, float attackSpeed, Properties settings) {
