...
CATEGORIES = [
    ...
    ("Transmutation", "The EMC economy, reskinned as Bound Light: dissolve matter, bank its Light Value, then withdraw Motes or condense an attuned item. Octave Stars carry it.",
     ["transmutation_table", "transmutation_tablet", "light_mote", "tonic_mote",
      "mediant_mote", "dominant_mote", "harmonic_mote",
...
STATS.update({
    ...
    "transmutation_table": [("Role", "Transmutation terminal"), ("Account", "per-player Bound Light + attuned tones"),
                            ("Dissolve", "matter → Light Value (+ attune)"),
                            ("Withdraw / Condense", "Mote coins · attuned items")],
    "transmutation_tablet": [("Role", "Portable terminal"), ("Opens", "your Bound-Light account anywhere"),
                             ("Same as", "the Transmutation Table")],
    "octave_star_1": [("Role", "Portable Bound-Light battery"), ("Capacity", "100,000"), ("Tier", "I of VI")],
    "octave_star_2": [("Role", "Portable Bound-Light battery"), ("Capacity", "400,000"), ("Tier", "II of VI")],
    "octave_star_3": [("Role", "Portable Bound-Light battery"), ("Capacity", "1,600,000"), ("Tier", "III of VI")],
    "octave_star_4": [("Role", "Portable Bound-Light battery"), ("Capacity", "6,400,000"), ("Tier", "IV of VI")],
    "octave_star_5": [("Role", "Portable Bound-Light battery"), ("Capacity", "25,600,000"), ("Tier", "V of VI")],
    "octave_star_6": [("Role", "Portable Bound-Light battery"), ("Capacity", "102,400,000"), ("Tier", "VI of VI")],
