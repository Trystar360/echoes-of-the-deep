#!/bin/bash
# Verifier v9 — Echoes of the Deep "fully loaded" acceptance checks
# Usage: verifier/v9/verify.sh ; exit 0 = PASS
cd "$(dirname "$0")/../.." || exit 1
fail=0
...
python3 verifier/v9/check_assets.py
...
python3 verifier/v9/check_textures32.py
