#!/bin/bash
# Verifier v5 — Echoes of the Deep "fully loaded" acceptance checks
# Usage: verifier/v5/verify.sh ; exit 0 = PASS
cd "$(dirname "$0")/../.." || exit 1
fail=0
...
python3 verifier/v5/check_assets.py
...
python3 verifier/v5/check_textures32.py
