#!/bin/bash
# Verifier v12 — Echoes of the Deep "fully loaded" acceptance checks
# Usage: verifier/v12/verify.sh ; exit 0 = PASS
cd "$(dirname "$0")/../.." || exit 1
fail=0
...
python3 verifier/v12/check_assets.py
...
python3 verifier/v12/check_textures32.py
